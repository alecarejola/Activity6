class TrainersController < ApplicationController
  ...
  def find
    @trainer = Trainer.where("LOWER(name) LIKE ?", "%" + params[:search_string].downcase + "%")
  end
  ...
  private
    ...
    def trainer_params
      params.require(:trainer).permit(:name, :address, :current_weight, :height, :gender, :email_address, :client_id)
    end
end
